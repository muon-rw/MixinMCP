...
of the IDE's "Continue". The signature/extract/introduce/inline/move-members tools are
Java-source only. Read each tool's description for parameters; below is only what isn't
obvious there.
